<x-app-layout>
    <x-admin.page>
        ...
        <x-admin.header title="Tambah Distributor" subtitle="Input distributor/supplier baru.">
            <x-slot:actions>
        ...
        <x-admin.card class="p-5 sm:p-6">
            <form method="POST" action="{{ route('distributor.store') }}" class="space-y-6">
                @csrf
                @include('distributor._form', ['item' => (object) []])
